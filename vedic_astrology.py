...
This script calculates sidereal ascendant, houses, and planetary positions
using Swiss Ephemeris with the Lahiri ayanamsa.
"""
...
def print_test_cases():
    """Print test cases for the script."""
    print("\nTest cases you can try:")
    print("1. Damian Adasik: 1997-09-17 13:04 Wroclaw Poland")
    print("2. Mateusz Skawiński: 1993-02-17 07:18 Radom Poland")
...
def main():
    ...
    # Get input from command-line arguments or via user prompts
    if len(sys.argv) == 5:
        date_str = sys.argv[1]
        time_str = sys.argv[2]
        city = sys.argv[3]
        ...
        print("Usage: python vedic_astrology.py <date> <time> <city> <country>")
        print("Example: python vedic_astrology.py 1997-09-17 13:04 Wroclaw Poland\n")
        print_test_cases()
